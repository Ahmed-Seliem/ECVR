...
(function (global, factory) {
  ...
  // thus there is no use in adding it to your project.
    Parsley.addMessages('ar', {
        defaultMessage: "القيمة المدخلة غير صالحة.",
        type: {
            email: "يجب أن يكون البريد الإلكتروني صالحًا.",
            url: "يجب أن يكون الرابط (URL) صالحًا.",
            number: "يجب أن يكون رقمًا صالحًا.",
            integer: "يجب أن يكون عددًا صحيحًا صالحًا.",
            digits: "يجب أن يحتوي فقط على أرقام.",
            alphanum: "يجب أن يحتوي فقط على أحرف وأرقام."
        },
        notblank: "لا يجب أن يكون هذا الحقل فارغًا.",
        required: "هذا الحقل مطلوب.",
        pattern: "القيمة المدخلة غير مطابقة للنمط المطلوب.",
        min: "يجب أن تكون القيمة أكبر من أو تساوي %s.",
        max: "يجب أن تكون القيمة أقل من أو تساوي %s.",
        range: "يجب أن تكون القيمة بين %s و %s.",
        minlength: "القيمة قصيرة جدًا. يجب أن تحتوي على %s حرف أو أكثر.",
        maxlength: "القيمة طويلة جدًا. يجب ألا تزيد عن %s حرف.",
        length: "طول القيمة غير صالح. يجب أن يكون بين %s و %s حرفًا.",
        mincheck: "يجب اختيار %s خيارات على الأقل.",
        maxcheck: "يجب ألا تختار أكثر من %s خيارات.",
        check: "يجب أن تختار بين %s و %s خيارات.",
        equalto: "يجب أن تكون القيمة مساوية."
    });
